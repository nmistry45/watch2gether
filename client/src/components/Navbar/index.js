...
function Navbar(props) {
  ...
  const renderMenu = (
    ...
    >
      <MenuItem value="Profile" onClick={(event) => handleClick(event)}>
        Profile
      </MenuItem>
      <MenuItem value="Logout" onClick={(event) => handleClick(event)}>
        Logout
      </MenuItem>
    </Menu>
  );
      ...
      <AppBar position="static">
        <Toolbar>
          ...
          <Button
            size="large"
            value="MOVIES"
            onClick={(event) => handleChange(event, "MOVIES")}
          ...
          <Button
            ...
            color="inherit"
            value="TV SHOWS"
            onClick={(event) => handleChange(event, "TV SHOWS")}
          >
            TV SHOWS
          </Button>
          <Box sx={{ flexGrow: 1 }} />
